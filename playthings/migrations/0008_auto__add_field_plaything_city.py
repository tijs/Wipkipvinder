...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plaything.city'
        db.add_column('playthings_plaything', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['playthings.City'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plaything.city'
        db.delete_column('playthings_plaything', 'city_id')
    ...
    models = {
        ...
        'playthings.plaything': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 3, 15, 10, 43, 658673)', 'auto_now_add': 'True', 'blank': 'True'}),
